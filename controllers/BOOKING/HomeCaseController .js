...
// import getUrgentCaseModel from '../../models/BOOKING/UrgentCaseModel.js';
// import getUrgentCaseModel from '../models/UrgentCaseModel.js';
...
//     await urgentCase.save();
//     res.json({ message: 'Booking accepted by DRA.' });
//   } catch (error) {
...
//     const DraUrgentCaseModel = req.conn1.model('UrgentCase'); // DRA DB (Target)
...
//       bookings: [booking], // Save only the accepted booking
//     });
